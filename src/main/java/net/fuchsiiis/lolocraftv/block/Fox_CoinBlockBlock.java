...
public class Fox_CoinBlockBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:fox_coin_block")
	public static final Block block = null;

	public Fox_CoinBlockBlock(LolocraftvModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fox_coin_block");
		}
