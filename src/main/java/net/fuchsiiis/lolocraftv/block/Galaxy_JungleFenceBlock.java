...
public class Galaxy_JungleFenceBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_jungle_fence")
	public static final Block block = null;

	public Galaxy_JungleFenceBlock(LolocraftvModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("galaxy_jungle_fence");
		}
