...
public class Galaxy_JungleFenceGateBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_jungle_fence_gate")
	public static final Block block = null;

	public Galaxy_JungleFenceGateBlock(LolocraftvModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("galaxy_jungle_fence_gate");
		}
