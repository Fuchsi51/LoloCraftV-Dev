...
public class Galaxy_JungleLogBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_jungle_log")
	public static final Block block = null;

	public Galaxy_JungleLogBlock(LolocraftvModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("galaxy_jungle_log");
		}
