...
import net.fuchsiiis.lolocraftv.procedures.GalaxyMegaNuceRedstoneAnProcedure;
...
public class GalaxyMegaNuceBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_mega_nuce")
	public static final Block block = null;

	public GalaxyMegaNuceBlock(LolocraftvModElements instance) {
		super(instance, 161);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("galaxy_mega_nuce");
		}
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				GalaxyMegaNuceRedstoneAnProcedure.executeProcedure(Stream
