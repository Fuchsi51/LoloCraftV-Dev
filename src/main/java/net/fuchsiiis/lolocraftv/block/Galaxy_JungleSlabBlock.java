...
public class Galaxy_JungleSlabBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_jungle_slab")
	public static final Block block = null;

	public Galaxy_JungleSlabBlock(LolocraftvModElements instance) {
		super(instance, 139);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("galaxy_jungle_slab");
		}
