...
public class Galaxy_JunglePressurePlateBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_jungle_pressure_plate")
	public static final Block block = null;

	public Galaxy_JunglePressurePlateBlock(LolocraftvModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("galaxy_jungle_pressure_plate");
		}
