...
public class Galaxy_JungleButtonBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_jungle_button")
	public static final Block block = null;

	public Galaxy_JungleButtonBlock(LolocraftvModElements instance) {
		super(instance, 143);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("galaxy_jungle_button");
		}
