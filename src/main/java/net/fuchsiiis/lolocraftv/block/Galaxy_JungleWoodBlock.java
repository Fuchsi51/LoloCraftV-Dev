...
public class Galaxy_JungleWoodBlock extends LolocraftvModElements.ModElement {
	@ObjectHolder("lolocraftv:galaxy_jungle_wood")
	public static final Block block = null;

	public Galaxy_JungleWoodBlock(LolocraftvModElements instance) {
		super(instance, 134);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("galaxy_jungle_wood");
		}
