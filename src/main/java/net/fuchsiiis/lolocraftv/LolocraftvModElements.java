...
public class LolocraftvModElements {
	...
	public LolocraftvModElements() {
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == LolocraftvModElements.ModElement.class)
						elements.add((LolocraftvModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(LolocraftvModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new LolocraftvModVariables(this));
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		LolocraftvMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final LolocraftvModElements elements;
		protected final int sortid;

		public ModElement(LolocraftvModElements elements, int sortid) {
