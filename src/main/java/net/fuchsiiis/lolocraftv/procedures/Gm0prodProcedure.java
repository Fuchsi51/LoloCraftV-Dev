...
public class Gm0prodProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				LolocraftvMod.LOGGER.warn("Failed to load dependency world for procedure Gm0prod!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				LolocraftvMod.LOGGER.warn("Failed to load dependency entity for procedure Gm0prod!");
			return;
		}
		...
		if (world.getWorldInfo().getGameRulesInstance().getBoolean(LcfastadminGameRule.gamerule) == true) {
			...
			if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
				((PlayerEntity) entity).sendStatusMessage(new StringTextComponent("Set you Gamemode to \"Survival\""), (true));
			}
		} else {
			if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
