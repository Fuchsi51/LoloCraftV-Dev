...
public class WilliEntity extends LolocraftvModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(null)).setRegistryName("willi_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(WilliMagicwandItem.block));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(WilliMagicwandItem.block));
		}
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			WilliMagicwandItem.shoot(this, target);
		}
