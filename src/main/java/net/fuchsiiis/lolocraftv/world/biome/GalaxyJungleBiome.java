...
public class GalaxyJungleBiome extends LolocraftvModElements.ModElement {
	public static Biome biome;

	public GalaxyJungleBiome(LolocraftvModElements instance) {
		super(instance, 157);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("lolocraftv:galaxy_jungle"));
			}
		}
	}
